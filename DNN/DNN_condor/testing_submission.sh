...
base_path="/eos/user/t/tcritchl/DNN/testing2"
...
for label in "${labels[@]}"; do
    ...
    echo "python3 /afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/DNN/DNN_condor/test_evaluate_model.py --label \"$label\"" >> "$script_file"
    chmod +x "$script_file"
