...
def plot_signal_vs_background(variable, label, variable_index):
    ...
    X_train = np.load(f'/eos/user/t/tcritchl/DNN/training10/X_train_{label}.npy')
    y_train = np.load(f'/eos/user/t/tcritchl/DNN/training10/y_train_{label}.npy')
    weights_train = np.load(f'/eos/user/t/tcritchl/DNN/training10/weights_train_{label}.npy')
