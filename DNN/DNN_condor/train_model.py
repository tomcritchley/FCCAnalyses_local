...
if __name__ == "__main__":
    ...
    history = model.fit(X_train, y_train, epochs=100, batch_size=256, validation_split=0.2, callbacks=callbacks,class_weight=class_weight_dict) #,class_weight=class_weight_dict)
