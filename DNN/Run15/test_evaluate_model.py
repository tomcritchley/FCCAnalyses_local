...
if __name__ == "__main__":
    ...
    def plot_confusion_matrix(y_true, y_pred, threshold=0.5): #threshold for confusion!
        ...
        plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/CM_{file}.pdf")
    ...
    X_train = np.load(f'/eos/user/t/tcritchl/DNN/training15/X_train_{file}.npy', allow_pickle=True)
    y_train = np.load(f'/eos/user/t/tcritchl/DNN/training15/y_train_{file}.npy', allow_pickle=True)
    X_test = np.load(f'/eos/user/t/tcritchl/DNN/testing15/X_test_{file}.npy', allow_pickle=True)
    y_test = np.load(f'/eos/user/t/tcritchl/DNN/testing15/y_test_{file}.npy', allow_pickle=True)
    weights_test = np.load(f'/eos/user/t/tcritchl/DNN/testing15/weights_test_{file}.npy', allow_pickle=True)
    ...
    model = tf.keras.models.load_model(f'/eos/user/t/tcritchl/DNN/trained_models15/DNN_HNLs_{file}.keras')
    ...
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/ROC_{file}.pdf")
    ...
    plt.tight_layout()
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/Precise_ROC_{file}.pdf")
    plt.close()
    ...
    plt.grid(True)
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/raw_dnn_classification_{file}.pdf")
    ...
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/raw_bkg_separated_{file}.pdf")
    ...
    plt.legend(loc='upper center')
    plt.grid(True)
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/scaled_dnn10fb_{file}.pdf")
    plt.close()
    ...
    plt.legend(loc='upper center')
    plt.grid(True)
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/scaled_dnn_150ab_{file}.pdf")
    plt.close()
    ...
    plt.savefig(f"/eos/user/t/tcritchl/DNN/DNN_plots15/DNN_output_{file}_10fb.pdf")
