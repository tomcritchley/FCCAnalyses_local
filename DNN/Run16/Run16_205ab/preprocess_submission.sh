...
base_path="/eos/user/t/tcritchl/DNN/testing16"
...
for label in "${labels[@]}"; do
    ...
    echo "python3.11 /afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/DNN/Run16/Run16_205ab/Data_Preparation.py --label \"$label\"" >> "$script_file"
    chmod +x "$script_file"
