...
def prepare_datasets():
    ...
    ## fix bug --> we are not correctly modifying the weights inside the original dataframes here since we concatenate first ##
    ...
    df_test.loc[df_test['label'] == 1, 'weight'] *= signal_weight_scale
    df_test.loc[df_test['label'] == 0, 'weight'] *= background_weight_scale
