...
json_files_path = '/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/DNN/Run16/*.json'  # Use *.json to match all JSON files
...
combined_json_path = '/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/xgboost_batch/DNN_results_FINAL.json'
