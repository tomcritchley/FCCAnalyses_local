...
cutList = {
    "selNone": "RecoDiJet_phi > -3.2",
    #"selRecoEleGt0":"n_RecoElectrons > 0", 
    #"selRecoEleEGt35": "RecoElectron_lead_e > 35", 
    #"selRecoElaeEGt11": "n_RecoElectrons > 0 && RecoElectron_lead_e > 11",
...
histoList = {
    ...
    "RecoElectronTrack_absD0":             {"name":"RecoElectronTrack_absD0",     "title":"Reco positron tracks |d_{0}| [mm]",      "bin":100,"xmin":0, "xmax":50},
    ...
    "Vertex_chi2":        {"name":"Vertex_chi2",        "title":"vertex #chi^{2}",          "bin":100,"xmin":0 ,"xmax":10},
    "n_primt":        {"name":"n_primt",        "title":"Number of primary tracks",          "bin":5,"xmin":-0.5 ,"xmax":20},
    "ntracks":        {"name":"ntracks",        "title":"Number of tracks",          "bin":5,"xmin":-0.5 ,"xmax":20},
