...
base_path="/eos/user/t/tcritchl/xgBOOST/testing12"
...
for label in "${labels[@]}"; do
    ...
    echo "python3 /afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/new_variables_training/LLP_study/testing_macro.py --label \"$label\"" >> "$script_file"
    chmod +x "$script_file"
