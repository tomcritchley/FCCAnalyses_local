...
json_files_path = '/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/new_variables_training/LLP_study/PromptDecay/*.json'  # Use *.json to match all JSON files
...
combined_json_path = '/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/new_variables_training/LLP_study/PromptDecay/PromptDecayRun15Results.json'
