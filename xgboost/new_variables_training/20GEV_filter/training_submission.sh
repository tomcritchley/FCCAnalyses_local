...
base_path="/eos/user/t/tcritchl/xgBOOST/training10"
...
for label in "${labels[@]}"; do
    ...
    echo "python3 /afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/new_variables_training/20GEV_filter/training_macro.py --label \"$label\"" >> "$script_file"
    chmod +x "$script_file"
