...
json_files_path = '/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/new_variables_training/*.json'  # Use *.json to match all JSON files
...
combined_json_path = '/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/xgboost/BDT_results_run17.json'
