...
output_dir =  HNL_type + "_ejj_massComp/"
output_dir_sel = HNL_type + "_ejj_massComp/" + selection +'/'
input_dir = "selected_hist/"

input_file_70GeV = input_dir + 'hist' + HNL_type + '_ejj_70GeV_1e-3Ve_' + selection + '.root'
input_file_50GeV = input_dir + 'hist' + HNL_type + '_ejj_50GeV_1e-3Ve_' + selection + '.root'
input_file_20GeV = input_dir + 'hist' + HNL_type + '_ejj_20GeV_1e-3Ve_' + selection + '.root'
...
files_list = [
    [input_file_20GeV , '20GeV ' + HNL_type + ' semi-leptonic', '20GeV'],
    [input_file_50GeV , '50GeV ' + HNL_type + ' semi-leptonic', '50GeV'],
    [input_file_70GeV , '70GeV ' + HNL_type + ' semi-leptonic', '70GeV']
]
...
def make_plot(h_list, plot_info, legend_list):
   #  print('looking at histogram:', plot_info[0])
    ...
    for ih,h in enumerate(h_list):
        ...
        h.GetYaxis().SetTitleSize(h.GetYaxis().GetTitleSize())
    ...
    c.SaveAs(output_dir_sel + plot_info[0]+ '_' + selection + '.png') if log_scale == False else c.SaveAs(output_dir_sel + "log_" + plot_info[0]+'.png')
    return
