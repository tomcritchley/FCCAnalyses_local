...
def make_plot(h_list_signal, h_list_bg, legend_list_signal, legend_list_bg, h_list_significance):
    ...
    # Background Legend
    leg_bg = ROOT.TLegend(0.70, 0.55, 0.90, 0.70)
    leg_bg.SetFillStyle(0)
    leg_bg.SetLineWidth(0)

    # Signal Legend
    leg_sig = ROOT.TLegend(0.70, 0.35, 0.90, 0.50)
    ...
    text_selection.DrawLatexNDC(0.10, 0.84, "#font[52]{No Selection}")

    text_lumi = ROOT.TLatex()
    text_lumi.SetTextSize(0.03)
    text_lumi.SetTextFont(42)
    text_lumi.DrawLatexNDC(0.10, 0.79, "#font[52]{#sqrt{s} = 91 GeV , #int L dt = 10 fb^{-1}}")
