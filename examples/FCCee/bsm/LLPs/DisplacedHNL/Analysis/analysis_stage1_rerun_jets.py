...
processList = {
        ...
        #private signals
        #'ejjnu':{},
	    #'HNL_Dirac_ejj_20GeV_1e-3Ve':{'fraction':0.000001},
	    #'20gev_1event':{},
...
class RDFanalysis():
		...
		#define the CROSS SECTION FOR THE BDT -> please change each time	
                .Define("cross_section","6654.46")
		#bb --> 6654.46, cc --> 5215.46, evjj --> 0.014	
		...
		#.Define("RecoLeadJet_p",        "JetClusteringUtils::get_p(RecoLeadJet)")
		#.Define("RecoSecondJet_p",        "JetClusteringUtils::get_p(RecoSecondJet)")
                #.Define("RecoLeadJet_m",        "JetClusteringUtils::get_p(RecoLeadJet)")
                #.Define("RecoSecondJet_m",        "JetClusteringUtils::get_p(RecoSecondJet)")
		...
		.Define("RecoDiJet_angle", "LeadingJet4Vect.Angle(SecondJet4Vect.Vect())")
		...
		.Define("RecoLeadElectron_Pmiss_delta_theta", "return atan2(sin(RecoMissingEnergy_theta - RecoHNLElectron_theta), cos(RecoMissingEnergy_theta - RecoHNLElectron_theta))")
		...
		.Define("VertexObject",  "VertexFitterSimple::VertexFitter_Tk( 0,EFlowTrack_1)")
      		.Define("Vertex_x",   "VertexObject.vertex.position[0]")
      		.Define("Vertex_y",   "VertexObject.vertex.position[1]")
     		.Define("Vertex_z",   "VertexObject.vertex.position[2]")
      		.Define("Vertex_chi2", "VertexObject.vertex.chi2")
      		.Define("Vertex_ntrk", "FCCAnalyses::VertexingUtils::get_VertexNtrk(VertexObject)")
      		.Define("ntracks","ReconstructedParticle2Track::getTK_n(EFlowTrack_1)")
      		.Define("PrimaryTracks","VertexFitterSimple::get_PrimaryTracks(EFlowTrack_1, false, 0, 0, 0, 0., 0., 0.)")
      		.Define("n_primt", "ReconstructedParticle2Track::getTK_n( PrimaryTracks)")
)
                return df2
        ...
        def output():
                branchList = [
                        ...
                        "RecoLeadElectron_Pmiss_delta_theta", 
