...
input_path = "/afs/cern.ch/user/d/dimoulin/FCCAnalyses_new/FCC-LLP/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/Analysis/outputs/HNL_Dirac_ejj_50GeV_1e-3Ve/output_finalSel/HNL_Dirac_ejj_50GeV_1e-3Ve_"+selection+"_histo.root"
output_file = "selected_hist/histDirac_ejj_50GeV_"+selection+".root"

hist_file = ROOT.TFile.Open(input_path)
#hist_file = ROOT.TFile.Open("../outputs/HNL_Dirac_20GeV_1e-3Ve/HNL_Dirac_20GeV_1e-3Ve_jets_selNone_histo.root")
