...
#inputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/HNL_sample_creation/100k_final_4body"
#inputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/HNL_sample_creation/4body/stage1"
#inputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/HNL_sample_creation/signal_HNLS/stage1_50k"
#inputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/HNL_sample_creation/signal_HNLS/stage1"

#Output directory where the files produced at the final-selection level are

#outputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/HNL_sample_creation/signal_HNLS/final_50k"
#aoutputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/background_final/full_stats/"
#outputDir = "/afs/cern.ch/work/t/tcritchl/full_background_21Nov_2023/"
outputDir = "/eos/user/t/tcritchl/HNls/final"
#outputDir = "/afs/cern.ch/work/t/tcritchl/full_background_8_11_23/p8_ee_Zbb_ecm91/"
#outputDir = "/eos/user/t/tcritchl/outputs/output_final/testingAll"
#outputDir = "/afs/cern.ch/user/t/tcritchl/testfinal/FCCAnalyses_local/examples/FCCee/bsm/LLPs/DisplacedHNL/HNL_sample_creation/signal_HNLS/out_final"
...
histoList = {
   ...
   "GenJets_ee_kt_e":      {"name":"GenJets_ee_kt_e",     "title":"Gen jet energy [GeV]",      "bin":100,"xmin":0, "xmax":100},
    ...
    #"RecoDiJet_angle_3":    {"name":"RecoDiJet_angle_3",      "title":"Reco di-jet angle 3", "bin":100,"xmin":0 ,"xmax":3.2},
    ...
    "RecoElectron_LeadJet_delta_R":      {"name":"RecoElectron_LeadJet_delta_R",     "title":"RecoElectron - LeadJet #Delta R",      "bin":100,"xmin":0, "xmax":4.5},
    "RecoElectron_SecondJet_delta_R":      {"name":"RecoElectron_SecondJet_delta_R",     "title":"RecoElectron - SecondJet #Delta R",      "bin":100,"xmin":0, "xmax":4.5},
    ...
    "RecoLeadElectron_Pmiss_delta_theta":        {"name":"RecoLeadElectron_Pmiss_delta_theta",        "title":"Reco electron neutrino angle [Rad.]", "bin":64,"xmin":-4 ,"xmax":4},
