...
output_path="/afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/run/DNN"
...
for label in "${labels[@]}"; do
    ...
    python3.11 //afs/cern.ch/work/t/tcritchl/FCCAnalyses_local/run/DNN/test_evaluate_model.py --label "$label"
done
